 ...
 * 
 * @see https://github.com/chrisjenx/ParallaxScrollView
 * @see git@github.com:chrisjenx/ParallaxScrollView.git
 */
public class ParallaxScrollView extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mScrollView != null) {
			measureChild(mScrollView, MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), MeasureSpec.AT_MOST),
		...
		if (mBackground != null) {
			...
			minHeight = Math.max(minHeight, MeasureSpec.getSize(heightMeasureSpec));// 此处计算background的高度

			measureChild(mBackground, MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), MeasureSpec.EXACTLY),
					MeasureSpec.makeMeasureSpec(minHeight, MeasureSpec.EXACTLY));// 此处调整background的高度
